...
<div class="dishCategories index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'assoview', $dishCategory['DishCategory']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'assoedit', $dishCategory['DishCategory']['id']), array('class' => 'btn btn-default btn-xs')); ?>
