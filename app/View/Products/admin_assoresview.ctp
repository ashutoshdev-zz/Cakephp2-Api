...
<h3>Actions</h3>
<?php echo $this->Html->link('Edit Product', array('action' => 'assoresedit', $product['Product']['id']), array('class' => 'btn btn-default')); ?>
&nbsp; &nbsp;
<?php echo $this->Form->postLink('Delete Product', array('action' => 'assoresdelete', $product['Product']['id']), array('class' => 'btn btn-danger'), __('Are you sure you want to delete # %s?', $product['Product']['id'])); ?>
<br/>
<br/>
